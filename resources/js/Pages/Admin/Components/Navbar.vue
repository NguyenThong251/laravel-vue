    ...
    >
        <div class="flex flex-wrap items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                >
                    <img
                        src="https://abc.hoangthong.asia/wp-content/uploads/2024/05/logoo-e1715963589128.png"
                        alt=""
                    />
                </Link>
                    ...
                    >
                        <li>
                            <Link
                                ...
                                method="post"
                                as="button"
                                class="block px-4 py-2 text-sm cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                            >
                                Sign out</Link
                            >
                        </li>
