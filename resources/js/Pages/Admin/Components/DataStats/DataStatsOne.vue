...
const calculateGrowthRate = (currentValue, previousValue) => {
    if (previousValue === 0) {
        return currentValue === 0 ? 0 : 100; // If both are zero, growth rate is 0; if previous is zero and current is not, growth rate is 100%
    }
...
const cardItems = ref([
    {
        ...
        title: "Total bills",
        total: props.totalBills,
        growthRate: 123,
        // calculateGrowthRate(
        //     props.totalBills,
        //     props.previousTotalBills
        // ),
    },
    {
        icon: `<svg
        ...
        title: "Total Profit",
        total: `$${props.totalProfit.toLocaleString()}`,
        growthRate: 4.35,
    },
    {
        icon: `<svg
