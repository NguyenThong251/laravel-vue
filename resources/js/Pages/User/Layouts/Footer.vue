<template>
    <!-- <div class="flex items-center h-12 mb-6 space-x-2">
                    <span class="text-2xl font-bold"
                        >Etra<span class="text-blue-600">de</span>.</span
                     >
                </div> -->
    <footer class="w-full">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 border-t-[1px]">
            <!--Grid-->
            <div
                class="grid max-w-sm grid-cols-2 gap-3 py-10 mx-auto sm:grid-cols-4 lg:grid-cols-6 gap-y-8 md:gap-8 sm:max-w-3xl lg:max-w-full"
            >
                <div class="mb-10 col-span-full lg:col-span-2 lg:mb-0">
                    ...
                    <p
                        class="pb-8 text-sm text-center text-gray-500 lg:max-w-xs lg:text-left"
                    >
                    ...
                    <a
                        href="javascript:;"
                        class="py-2.5 px-5 h-9 block w-fit bg-blue-700 rounded-full shadow-sm text-xs text-white mx-auto transition-all duration-500 hover:bg-indigo-700 lg:mx-0"
                    >
                        Contact us
                    </a>
                </div>
                ...
                <div class="text-left lg:mx-auto">
                    ...
                    <a
                        href="javascript:;"
                        class="flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold text-indigo-600 transition-all duration-500 border border-indigo-600 rounded-full w-fit lg:mx-0 hover:bg-indigo-50"
                        >Subscribe<svg
                            width="15"
                            height="12"
                            viewBox="0 0 15 12"
            ...
            <div class="border-t border-gray-200 py-7">
                <div
                    class="flex flex-col items-center justify-center lg:justify-between lg:flex-row"
                >
                    <span class="text-sm text-gray-500"
                        >©<a href="https://pagedone.io/">Etrade</a> 2024, All
